...
public class MeasurementRange {
  ...
  public boolean equals(Object o) {
    ...
    return (this.lowerLimit == null ? measurementRange.lowerLimit == null : this.lowerLimit.equals(measurementRange.lowerLimit)) &&
        (this.upperLimit == null ? measurementRange.upperLimit == null : this.upperLimit.equals(measurementRange.upperLimit));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.lowerLimit == null ? 0: this.lowerLimit.hashCode());
    result = 31 * result + (this.upperLimit == null ? 0: this.upperLimit.hashCode());
    return result;
  }
