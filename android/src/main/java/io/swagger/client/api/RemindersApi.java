...
public class RemindersApi {
  ...
  */
  public InlineResponse2002 v1TrackingReminderNotificationsGet (String accessToken, Integer userId, String variableCategoryName, String createdAt, String updatedAt, Integer limit, Integer offset, String sort) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public CommonResponse v1TrackingReminderNotificationsSkipPost (TrackingReminderNotificationSkip body, String accessToken, Integer userId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Skip a pending tracking reminder
   * Deletes the pending tracking reminder
   * @param body Id of the pending reminder to be skipped or deleted   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id
  */
  public void v1TrackingReminderNotificationsSkipPost (TrackingReminderNotificationSkip body, String accessToken, Integer userId, final Response.Listener<CommonResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  * Changes the reminder time to now plus one hour
   ...
   * @return CommonResponse
  */
  public CommonResponse v1TrackingReminderNotificationsSnoozePost (TrackingReminderNotificationSnooze body, String accessToken, Integer userId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
   ...
   * Snooze a pending tracking reminder
   * Changes the reminder time to now plus one hour
   * @param body Id of the pending reminder to be snoozed   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id
  */
  public void v1TrackingReminderNotificationsSnoozePost (TrackingReminderNotificationSnooze body, String accessToken, Integer userId, final Response.Listener<CommonResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  * Adds the default measurement for the pending tracking reminder with the reminder time as the measurment start time
   ...
   * @return CommonResponse
  */
  public CommonResponse v1TrackingReminderNotificationsTrackPost (TrackingReminderNotificationTrack body, String accessToken, Integer userId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
   ...
   * Track a pending tracking reminder
   * Adds the default measurement for the pending tracking reminder with the reminder time as the measurment start time
   * @param body Id of the pending reminder to be tracked   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id
  */
  public void v1TrackingReminderNotificationsTrackPost (TrackingReminderNotificationTrack body, String accessToken, Integer userId, final Response.Listener<CommonResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  * Delete previously created tracking reminder
   ...
   * @return CommonResponse
  */
  public CommonResponse v1TrackingRemindersDeletePost (TrackingReminderDelete body, String accessToken, Integer userId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
   ...
   * Delete tracking reminder
   * Delete previously created tracking reminder
   * @param body Id of reminder to be deleted   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id
  */
  public void v1TrackingRemindersDeletePost (TrackingReminderDelete body, String accessToken, Integer userId, final Response.Listener<CommonResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  */
  public InlineResponse200 v1TrackingRemindersGet (String accessToken, Integer userId, String variableCategoryName, String createdAt, String updatedAt, Integer limit, Integer offset, String sort) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
   ...
   * Get repeating tracking reminder settings
   * Users can be reminded to track certain variables at a specified frequency with a default value.
   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id   * @param variableCategoryName Limit tracking reminders to a specific variable category   * @param createdAt When the record was first created. Use UTC ISO 8601 \&quot;YYYY-MM-DDThh:mm:ss\&quot;  datetime format. Time zone should be UTC and not local.   * @param updatedAt When the record was last updated. Use UTC ISO 8601 \&quot;YYYY-MM-DDThh:mm:ss\&quot;  datetime format. Time zone should be UTC and not local.   * @param limit The LIMIT is used to limit the number of results returned. So if you have 1000 results, but only want to the first 10, you would set this to 10 and offset to 0. The maximum limit is 200 records.   * @param offset OFFSET says to skip that many rows before beginning to return rows to the client. OFFSET 0 is the same as omitting the OFFSET clause. If both OFFSET and LIMIT appear, then OFFSET rows are skipped before starting to count the LIMIT rows that are returned.   * @param sort Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.
  */
  public void v1TrackingRemindersGet (String accessToken, Integer userId, String variableCategoryName, String createdAt, String updatedAt, Integer limit, Integer offset, String sort, final Response.Listener<InlineResponse200> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public InlineResponse2001 v1TrackingRemindersPost (String accessToken, Integer userId, TrackingReminder body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
   ...
   * Store a Tracking Reminder
   * This is to enable users to create reminders to track a variable with a default value at a specified frequency
   * @param accessToken User&#39;s OAuth2 access token   * @param userId User&#39;s id   * @param body TrackingReminder that should be stored
  */
  public void v1TrackingRemindersPost (String accessToken, Integer userId, TrackingReminder body, final Response.Listener<InlineResponse2001> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
