...
------------ | ------------- | ------------- | -------------
**averageDailyLowCause** | [**BigDecimal**](BigDecimal.md) |  |  [optional]
**averageDailyHighCause** | [**BigDecimal**](BigDecimal.md) |  |  [optional]
**averageEffect** | [**BigDecimal**](BigDecimal.md) |  |  [optional]
**averageEffectFollowingHighCause** | [**BigDecimal**](BigDecimal.md) |  |  [optional]
**averageEffectFollowingLowCause** | [**BigDecimal**](BigDecimal.md) |  |  [optional]
...
**causeChanges** | **Integer** | Number of changes in the predictor variable (a.k.a the number of experiments) |  [optional]
...
**causeVariableDefaultUnitId** | **Integer** | Unit Id of the predictor variable |  [optional]
**causeVariableId** | **Integer** |  |  [optional]
