...
public class Credential  {
   ...
   **/
  @ApiModelProperty(required = true, value = "Attribute name such as token, userid, username, or password")
   ...
   **/
  @ApiModelProperty(required = true, value = "Encrypted value for the attribute specified")
  ...
  public boolean equals(Object o) {
    ...
    return (userId == null ? credential.userId == null : userId.equals(credential.userId)) &&
        (connectorId == null ? credential.connectorId == null : connectorId.equals(credential.connectorId)) &&
        (attrKey == null ? credential.attrKey == null : attrKey.equals(credential.attrKey)) &&
        (attrValue == null ? credential.attrValue == null : attrValue.equals(credential.attrValue)) &&
        (createdAt == null ? credential.createdAt == null : createdAt.equals(credential.createdAt)) &&
        (updatedAt == null ? credential.updatedAt == null : updatedAt.equals(credential.updatedAt));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (attrKey == null ? 0: attrKey.hashCode());
    result = 31 * result + (attrValue == null ? 0: attrValue.hashCode());
