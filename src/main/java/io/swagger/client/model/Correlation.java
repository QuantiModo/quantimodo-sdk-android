...
public class Correlation  {
  ...
  public boolean equals(Object o) {
    ...
    return (correlationCoefficient == null ? correlation.correlationCoefficient == null : correlationCoefficient.equals(correlation.correlationCoefficient)) &&
        (cause == null ? correlation.cause == null : cause.equals(correlation.cause)) &&
        (originalCause == null ? correlation.originalCause == null : originalCause.equals(correlation.originalCause)) &&
        (effect == null ? correlation.effect == null : effect.equals(correlation.effect)) &&
        (originalEffect == null ? correlation.originalEffect == null : originalEffect.equals(correlation.originalEffect)) &&
        (onsetDelay == null ? correlation.onsetDelay == null : onsetDelay.equals(correlation.onsetDelay)) &&
        (durationOfAction == null ? correlation.durationOfAction == null : durationOfAction.equals(correlation.durationOfAction)) &&
        (numberOfPairs == null ? correlation.numberOfPairs == null : numberOfPairs.equals(correlation.numberOfPairs)) &&
        (effectSize == null ? correlation.effectSize == null : effectSize.equals(correlation.effectSize)) &&
        (statisticalSignificance == null ? correlation.statisticalSignificance == null : statisticalSignificance.equals(correlation.statisticalSignificance)) &&
        (timestamp == null ? correlation.timestamp == null : timestamp.equals(correlation.timestamp)) &&
        (reverseCorrelation == null ? correlation.reverseCorrelation == null : reverseCorrelation.equals(correlation.reverseCorrelation)) &&
        (causalityFactor == null ? correlation.causalityFactor == null : causalityFactor.equals(correlation.causalityFactor)) &&
        (causeCategory == null ? correlation.causeCategory == null : causeCategory.equals(correlation.causeCategory)) &&
        (effectCategory == null ? correlation.effectCategory == null : effectCategory.equals(correlation.effectCategory)) &&
        (valuePredictingHighOutcome == null ? correlation.valuePredictingHighOutcome == null : valuePredictingHighOutcome.equals(correlation.valuePredictingHighOutcome)) &&
        (valuePredictingLowOutcome == null ? correlation.valuePredictingLowOutcome == null : valuePredictingLowOutcome.equals(correlation.valuePredictingLowOutcome)) &&
        (optimalPearsonProduct == null ? correlation.optimalPearsonProduct == null : optimalPearsonProduct.equals(correlation.optimalPearsonProduct)) &&
        (averageVote == null ? correlation.averageVote == null : averageVote.equals(correlation.averageVote)) &&
        (userVote == null ? correlation.userVote == null : userVote.equals(correlation.userVote)) &&
        (causeUnit == null ? correlation.causeUnit == null : causeUnit.equals(correlation.causeUnit)) &&
        (causeUnitId == null ? correlation.causeUnitId == null : causeUnitId.equals(correlation.causeUnitId));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (correlationCoefficient == null ? 0: correlationCoefficient.hashCode());
    result = 31 * result + (cause == null ? 0: cause.hashCode());
    result = 31 * result + (originalCause == null ? 0: originalCause.hashCode());
    result = 31 * result + (effect == null ? 0: effect.hashCode());
    result = 31 * result + (originalEffect == null ? 0: originalEffect.hashCode());
    result = 31 * result + (onsetDelay == null ? 0: onsetDelay.hashCode());
    result = 31 * result + (durationOfAction == null ? 0: durationOfAction.hashCode());
    result = 31 * result + (numberOfPairs == null ? 0: numberOfPairs.hashCode());
    result = 31 * result + (effectSize == null ? 0: effectSize.hashCode());
    result = 31 * result + (statisticalSignificance == null ? 0: statisticalSignificance.hashCode());
    result = 31 * result + (timestamp == null ? 0: timestamp.hashCode());
    result = 31 * result + (reverseCorrelation == null ? 0: reverseCorrelation.hashCode());
    result = 31 * result + (causalityFactor == null ? 0: causalityFactor.hashCode());
    result = 31 * result + (causeCategory == null ? 0: causeCategory.hashCode());
    result = 31 * result + (effectCategory == null ? 0: effectCategory.hashCode());
    ...
    result = 31 * result + (optimalPearsonProduct == null ? 0: optimalPearsonProduct.hashCode());
    result = 31 * result + (averageVote == null ? 0: averageVote.hashCode());
    result = 31 * result + (userVote == null ? 0: userVote.hashCode());
    result = 31 * result + (causeUnit == null ? 0: causeUnit.hashCode());
    result = 31 * result + (causeUnitId == null ? 0: causeUnitId.hashCode());
    return result;
  }
