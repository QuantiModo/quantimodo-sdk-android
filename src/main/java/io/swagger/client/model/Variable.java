...
public class Variable  {
  ...
  public boolean equals(Object o) {
    ...
    return (id == null ? variable.id == null : id.equals(variable.id)) &&
        (name == null ? variable.name == null : name.equals(variable.name)) &&
        (originalName == null ? variable.originalName == null : originalName.equals(variable.originalName)) &&
        (category == null ? variable.category == null : category.equals(variable.category)) &&
        (abbreviatedUnitName == null ? variable.abbreviatedUnitName == null : abbreviatedUnitName.equals(variable.abbreviatedUnitName)) &&
        (abbreviatedUnitId == null ? variable.abbreviatedUnitId == null : abbreviatedUnitId.equals(variable.abbreviatedUnitId)) &&
        (sources == null ? variable.sources == null : sources.equals(variable.sources)) &&
        (minimumValue == null ? variable.minimumValue == null : minimumValue.equals(variable.minimumValue)) &&
        (maximumValue == null ? variable.maximumValue == null : maximumValue.equals(variable.maximumValue)) &&
        (combinationOperation == null ? variable.combinationOperation == null : combinationOperation.equals(variable.combinationOperation)) &&
        (fillingValue == null ? variable.fillingValue == null : fillingValue.equals(variable.fillingValue)) &&
        (joinWith == null ? variable.joinWith == null : joinWith.equals(variable.joinWith)) &&
        (joinedVariables == null ? variable.joinedVariables == null : joinedVariables.equals(variable.joinedVariables)) &&
        (parent == null ? variable.parent == null : parent.equals(variable.parent)) &&
        (subVariables == null ? variable.subVariables == null : subVariables.equals(variable.subVariables)) &&
        (onsetDelay == null ? variable.onsetDelay == null : onsetDelay.equals(variable.onsetDelay)) &&
        (durationOfAction == null ? variable.durationOfAction == null : durationOfAction.equals(variable.durationOfAction)) &&
        (earliestMeasurementTime == null ? variable.earliestMeasurementTime == null : earliestMeasurementTime.equals(variable.earliestMeasurementTime)) &&
        (latestMeasurementTime == null ? variable.latestMeasurementTime == null : latestMeasurementTime.equals(variable.latestMeasurementTime)) &&
        (updated == null ? variable.updated == null : updated.equals(variable.updated)) &&
        (causeOnly == null ? variable.causeOnly == null : causeOnly.equals(variable.causeOnly)) &&
        (numberOfCorrelations == null ? variable.numberOfCorrelations == null : numberOfCorrelations.equals(variable.numberOfCorrelations)) &&
        (outcome == null ? variable.outcome == null : outcome.equals(variable.outcome)) &&
        (measurementsAtLastAnalysis == null ? variable.measurementsAtLastAnalysis == null : measurementsAtLastAnalysis.equals(variable.measurementsAtLastAnalysis)) &&
        (numberOfMeasurements == null ? variable.numberOfMeasurements == null : numberOfMeasurements.equals(variable.numberOfMeasurements)) &&
        (lastUnit == null ? variable.lastUnit == null : lastUnit.equals(variable.lastUnit)) &&
        (lastValue == null ? variable.lastValue == null : lastValue.equals(variable.lastValue)) &&
        (mostCommonValue == null ? variable.mostCommonValue == null : mostCommonValue.equals(variable.mostCommonValue)) &&
        (mostCommonUnit == null ? variable.mostCommonUnit == null : mostCommonUnit.equals(variable.mostCommonUnit)) &&
        (lastSource == null ? variable.lastSource == null : lastSource.equals(variable.lastSource));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (originalName == null ? 0: originalName.hashCode());
    ...
    result = 31 * result + (abbreviatedUnitId == null ? 0: abbreviatedUnitId.hashCode());
    ...
    result = 31 * result + (joinedVariables == null ? 0: joinedVariables.hashCode());
    result = 31 * result + (parent == null ? 0: parent.hashCode());
    result = 31 * result + (subVariables == null ? 0: subVariables.hashCode());
    ...
    result = 31 * result + (lastUnit == null ? 0: lastUnit.hashCode());
    result = 31 * result + (lastValue == null ? 0: lastValue.hashCode());
    result = 31 * result + (mostCommonValue == null ? 0: mostCommonValue.hashCode());
    result = 31 * result + (mostCommonUnit == null ? 0: mostCommonUnit.hashCode());
    result = 31 * result + (lastSource == null ? 0: lastSource.hashCode());
    return result;
  }
