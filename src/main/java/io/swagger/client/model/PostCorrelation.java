...
public class PostCorrelation  {
  ...
  public boolean equals(Object o) {
    ...
    return (cause == null ? postCorrelation.cause == null : cause.equals(postCorrelation.cause)) &&
        (effect == null ? postCorrelation.effect == null : effect.equals(postCorrelation.effect)) &&
        (correlation == null ? postCorrelation.correlation == null : correlation.equals(postCorrelation.correlation)) &&
        (vote == null ? postCorrelation.vote == null : vote.equals(postCorrelation.vote));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (correlation == null ? 0: correlation.hashCode());
