...
public class ConnectorsApi {
   ...
   * @return void
   */
  public void  v1ConnectJsGet (String access token, String mashape key) throws ApiException {
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "access token", access token));
    
    queryParams.addAll(ApiInvoker.parameterToPairs("", "mashape key", mashape key));
   ...
   * @return void
   */
  public void  v1ConnectorsConnectorConnectInstructionsGet (String connector, String parameters, String url, Boolean usePopup) throws ApiException {
    Object postBody = null;
   ...
   */
  public ConnectorInstruction  v1ConnectorsConnectorConnectParameterGet (String connector, String displayName, String key, String placeholder, String type, Boolean usePopup, String defaultValue) throws ApiException {
    Object postBody = null;
