...
public class PairsApi {
   ...
   * @return List<Pairs>
   */
  public List<Pairs>  v1PairsGet (String cause, String effect, String causeSource, String causeUnit, String delay, String duration, String effectSource, String effectUnit, String endTime, String startTime, Integer limit, Integer offset, Integer sort) throws ApiException {
