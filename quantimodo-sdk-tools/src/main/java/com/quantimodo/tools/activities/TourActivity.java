...
import com.quantimodo.tools.fragments.TourFragment;
...
public class TourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qmt_activity_tour);
    ...
    private void setIndicator(int index){
        if(index < NUM_PAGES){
            for(int i = 0 ; i < NUM_PAGES - 1 ; i++){
                ...
                if(i == index){
                    circle.setColorFilter(getResources().getColor(R.color.tour_circle_selected));
                }else {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                case 0:
                    tp = TourFragment.newInstance(R.layout.qmt_tour_fragment1);
                    break;
                case 1:
                    tp = TourFragment.newInstance(R.layout.qmt_tour_fragment2);
                    break;
                case 2:
                    tp = TourFragment.newInstance(R.layout.qmt_tour_fragment3);
                    break;
                case 3:
                    tp = TourFragment.newInstance(R.layout.qmt_empty_tour_fragment);
                    break;
            }
            return tp;
        }
